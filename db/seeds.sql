...
VALUES (001, "Rik", "Delinger", null),
       ...
       (012, "Emily", "Palik", 17),
       (013, "Pat", "Rolfe", "IT", null),
       (014, "Mike", "Medendorp", 21),
       (015, "Kaleb", "Schumaker", 21),
       (015, "Eric", "Fisher", "IT", 21),
       (016, "Loren", "Torrez", "Lab", "Quality Manager", "null", null),
       (017, "Jeff", "Mier", "Lab", 25),
       (017, "Wade", "Begrow", "Lab", 25),
       (017, "Elliot", "Parcell", "Lab", 25),
       (018, "Mike", "Simon", "Logistics", null),
       (019, "Kenyatta", "Mayfield", "Logistics", 29),
       (020, "David", "Zapanta", "Logistics", 29),
       (020, "Kelly", "Ward", "Logistics", 29),
       (021, "Dan", "Houston", "Maintenance", null),
       (022, "Sid", "Carrizales", "Maintenance", 33),
       (023, "Doug", "Spencer", "Maintenance", 33),
       (023, "David", "West", "Maintenance", 33),
       (024, "John", "Mallet", "Executive", null),
       (025, "Tim", "Gossack", "Executive", 37),
       (026, "Alex", "Kettles", "Executive", 37),
       (027, "Andy", "Farrel", "Executive", 37),
       (028, "Tina", "Anderson", null),
       (029, "David", "Munro", 41),
       (029, "Victoria", "Saunders", 41),
       (029, "Mike", "Hamel", "Sales", 41),
